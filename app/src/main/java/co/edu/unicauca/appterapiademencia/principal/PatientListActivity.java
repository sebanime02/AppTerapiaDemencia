...
public class PatientListActivity  extends AppCompatActivity implements SearchView.OnQueryTextListener, MenuItemCompat.OnActionExpandListener {
                    ...
                    public boolean onNavigationItemSelected(MenuItem menuItem) {
                        ...
                        switch (menuItem.getItemId()) {
                            ...
                            case R.id.item_navigation_drawer_salir:
                                ...
                                editor.commit();
                                Intent i2 = new Intent(PatientListActivity.this, LoginActivity.class);
                                startActivity(i2);
                                finish();
                                return true;
                            default:
