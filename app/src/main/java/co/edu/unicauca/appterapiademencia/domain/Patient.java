...
public class Patient {
    ...
    public List<Rutina> getRutinaList() {
        if (rutinaList == null) {
            __throwIfDetached();
            RutinaDao targetDao = daoSession.getRutinaDao();
            List<Rutina> rutinaListNew = targetDao._queryPatient_RutinaList(id);
            synchronized (this) {
                if(rutinaList == null) {
                    rutinaList = rutinaListNew;
                }
            }
        }
        return rutinaList;
    ...
    /** Resets a to-many relationship, making the next get call to query for a fresh result. */
    @Generated
    public synchronized void resetRutinaList() {
        rutinaList = null;
    }
